...
def default_savgol(radii):
    return savgol_filter(radii, 21, 1, axis=1)
...
class DataSet(object):
    def __init__(self, data_folders, setups,
        ...
        self.parse_radii(radii1, radii2, post_filter)
        self.laser = dict()
        self.parse_laser(laser_data)

    def parse_radii(self, radii1, radii2, post_filter=default_savgol):
        ...
        # smooth
        self['radii1'] = post_filter(radii1)
        self['radii2'] = post_filter(radii2)
